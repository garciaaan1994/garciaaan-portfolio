        ...
        <div className="grid gap-16 md:grid-cols-[1fr_1.5fr] md:gap-24">
          ...
          <div>
            ...
            <a
              ...
              className="mt-4 inline-block border border-white/10 px-6 py-2.5 text-[10px] tracking-[0.3em] text-white/50 uppercase transition-all hover:border-white/30 hover:text-white/80"
              data-cursor-hover
            >
              Get in touch
            </a>
